...
public class PackOpeningPlugin extends PluginContext {
	public enum PackData {
		...
		SOUL_SET(13654, new Item(13692, 1), new Item(13693, 1), new Item(13695, 1), new Item(13696, 1),
				new Item(17160, 1)),
		DEATH_SET(7959, new Item(17157, 1), new Item(17162, 1), new Item(17159, 1), new Item(17158, 1)),
	    ...
	    private final static PackData[] infomation = PackData.values();

		public static PackData forItem(Item item) {
			for (PackData pack : infomation) {
