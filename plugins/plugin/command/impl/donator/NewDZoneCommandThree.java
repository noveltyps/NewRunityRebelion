...
public class NewDZoneCommandThree implements Command {

	@Override
	public void execute(Player player, String command, String[] parts) {
		Teleportation.teleport(player, new Position(2040, 4502));
	...
	public boolean canUse(Player player) {
		return  (PlayerRight.isKing(player) || PlayerRight.isSupreme(player) || PlayerRight.isDeveloper(player));
	}
