...
public enum ItemPack {
	REFERRAL(6828, false, new Item(6199)),
	// barrows
	...
	PARTY_HAT_SET(13173, true, new Item(1038), new Item(1040), new Item(1044), new Item(1046), new Item(1048),
			new Item(2422)),
	...
	/* Packs */
	EMPTY_VIAL_PACK(11877, false, new Item(230, 100)), WATER_FILLED_VIAL_PACK(11879, false, new Item(228, 100)),
	FEATHER_PACK(11881, false, new Item(314, 100)), BAIT_PACK(11883, false, new Item(313, 100)),
	SOFT_CLAY_PACK(12009, false, new Item(1762, 100)), BROAD_ARROWHEAD_PACK(11885, false, new Item(11874, 100)),
	AIR_RUNE_PACK(12728, false, new Item(556, 100)), WATER_RUNE_PACK(12730, false, new Item(555, 100)),
	EARTH_RUNE_PACK(12732, false, new Item(557, 100)), FIRE_RUNE_PACK(12734, false, new Item(554, 100)),
	MIND_RUNE_PACK(12736, false, new Item(558, 100)), CHAOS_RUNE_PACK(12738, false, new Item(562, 100)),
	BIRD_SNARE_PACK(12740, false, new Item(10007, 100)), BOX_SNARE_PACK(12742, false, new Item(10009, 100)),
	MAGIC_BOX_PACK(12744, false, new Item(10026, 100)), EYE_OF_NEW_PACK(12859, false, new Item(222, 100)),

	/* Magic Box */
	MAGIC_BOX(10025, false, new Item(554, 250), new Item(555, 250), new Item(556, 250), new Item(557, 250),
			new Item(558, 250), new Item(563, 50), new Item(561, 30), new Item(562, 100)),;
