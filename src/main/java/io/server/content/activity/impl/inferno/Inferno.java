package io.server.content.activity.impl.inferno;
...
import io.server.content.activity.impl.inferno.InfernoWaveData.WaveData;
...
public class Inferno extends Activity {
	...
	public void finish() {
		...
		if (completed) {
			...
			player.inventory.addOrDrop(new Item(21295));
			}
