...
public enum PlayerGuideData {
	...
	Introduction(-9485, PlayerGuideDifficulty.EASY, "Introduction",
			new String[] { "If you need any information,", "based on RebelionX, select one of the options"," shown in our navigation bar",
	...
	Economy_Information(-9484, PlayerGuideDifficulty.EASY, "Main Currency?",
			new String[] { "Our economy is built by the players,", "We have introduced 1Bill and 500 Mill Tickets.",
					...
					"From donating and from voting.", "They can be spent in various shops ", "all over RebelionX",
					"such as the Rare Store and Customs store", "& PVM & Misc Items Store!", "", "", "", "", "", "", "",
					"", "" }),

	Money_Making(-9483, PlayerGuideDifficulty.EASY, "Making Bank?", 
			new String[] { "There are various ways in which a,", "player can obtain money on RebelionX.",
			"One of most effective ways is PvM'ing", "& Skilling.", "RebelionX has over 30+ Bosses.",
	...
	Voting(-9482, PlayerGuideDifficulty.EASY, "Voting",
			new String[] { "Use ::vote to vote for us",
					"Voting for our server will increase", "the amount of players on RebelionX.", "",
	...
	Donate(-9475, PlayerGuideDifficulty.EASY, "Donate",
			new String[] { "You can help support RebelionX ",
	...
	Help_me(-9474, PlayerGuideDifficulty.EASY, "Help me",
			new String[] { "- Contact a staff member on ::staff", "- Ask a question in the RebelionX clan chat for",
