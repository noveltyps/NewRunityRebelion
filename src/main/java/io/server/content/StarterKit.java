...
public class StarterKit {
	...
	public enum KitData {
		...
		NORMAL(PlayerRight.PLAYER, new String[] {
				"", "Play BrutalOS as a normal player.", "As a normal player you will have no restrictions at all." },
		...
		CLASSIC(PlayerRight.CLASSIC, new String[] {
				"", "Play BrutalOS as a Classic player.", "As a normal player you will have no restrictions at all." },
