...
public enum SlayerUnlockable {
	SLAYER_HELM("Malevolent masquerade", 11864, 500,
			"Learn to combine the protective Slayer\\nheadgear & Slayer gem into one universal\\nhelmet. 55 crafting needed."),
	BROAD_BOLT("Broader fletching", 11874, 250,
			"Learn to fletch broad arrows (with level 52\\nfletching) and broad bolts (with level 55 \\nfletching)."),
	RING_OF_WEALTH("Ring bling", 2572, 300, "Learn to craft your own Slayer rings, with\\nlevel 75 crafting."),
	CANNON_BALLS("Balls of fury", 2, 200, "Learn to craft your own cannonballs, with\\nlevel 35 smithing."),
	ZULRAH("Give me venom", 12924, 300,
			"Unlock the ability to be assigned Zulrah as\\na Slayer task, 95 Slayer needed."),
	CERBERUS("Beast Slayer", 13239, 250,
			"Unlock the ability to be assigned Cerberus\\nas a Slayer task, 85 Slayer needed."),
	KING_BLACK_DRAGON("King killer", 11283, 300,
			"Unlock the ability to be assigned King black\\ndragon as a Slayer task, 75 Slayer needed."),
	CHAOS_ELEMENT("I strive on chaos", 12694, 150,
			"Unlock the ability to be assigned Chaos\\nelemental as a Slayer task, 65 Slayer\\nneeded."),
	CRAZY_ARCHAEOLOGIST("You drive me crazy", 11990, 100,
			"Unlock the ability to be assigned Crazy\\narchaeologist as a Slayer task, 60\\nSlayer needed."),;
