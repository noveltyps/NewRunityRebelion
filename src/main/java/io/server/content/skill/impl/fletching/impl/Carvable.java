...
public enum Carvable implements Fletchable {
	...
	LOG(new Item(946), new Item(1511), new FletchableItem(new Item(52, 15), 1, 5.0),
			new FletchableItem(new Item(50), 5, 5.0), new FletchableItem(new Item(48), 10, 10.0),
			new FletchableItem(new Item(9440), 9, 6.0)),
	OAK_LOG(new Item(946), new Item(1521), new FletchableItem(new Item(54), 20, 16.5),
			new FletchableItem(new Item(56), 25, 25.0), new FletchableItem(new Item(9442), 24, 16.0)),
	WILLOW_LOG(new Item(946), new Item(1519), new FletchableItem(new Item(60), 35, 33.3),
			new FletchableItem(new Item(58), 40, 41.5), new FletchableItem(new Item(9444), 39, 22.0)),
	TEAK_LOG(new Item(946), new Item(6333), new FletchableItem(new Item(9446), 46, 27.0)),
	MAPLE_LOG(new Item(946), new Item(1517), new FletchableItem(new Item(64), 50, 50.0),
			new FletchableItem(new Item(62), 55, 51.3), new FletchableItem(new Item(9448), 54, 32.0)),
	MAHOGANY_LOG(new Item(946), new Item(6332), new FletchableItem(new Item(9450), 61, 41.0)),
	YEW_LOG(new Item(946), new Item(1515), new FletchableItem(new Item(68), 65, 67.5),
			new FletchableItem(new Item(66), 70, 75.0), new FletchableItem(new Item(9452), 69, 50.0)),
	MAGIC_LOG(new Item(946), new Item(1513), new FletchableItem(new Item(72), 80, 83.3),
			new FletchableItem(new Item(70), 85, 91.5)),
