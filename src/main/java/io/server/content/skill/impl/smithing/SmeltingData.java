...
public enum SmeltingData {
	...
	BRONZE_5(3986, BRONZE, 5), BRONZE_10(2807, BRONZE, 10), BRONZE_X(2414, BRONZE, -1),
	IRON(3991, new Item[] { new Item(440) }, new Item[] { new Item(2351) }, 12.5, 15), IRON_5(3990, IRON, 5),
	IRON_10(3989, IRON, 10), IRON_X(3988, IRON, -1),
	SILVER(3995, new Item[] { new Item(442) }, new Item[] { new Item(2355) }, 13.67, 20), SILVER_5(3994, SILVER, 5),
	SILVER_10(3993, SILVER, 10), SILVER_X(3992, SILVER, -1),
	...
	GOLD(4003, new Item[] { new Item(444) }, new Item[] { new Item(2357) }, 22.5, 40), GOLD_5(4002, GOLD, 5),
	GOLD_10(4001, GOLD, 10), GOLD_X(4000, GOLD, -1),
	MITHRIL(7441, new Item[] { new Item(447), new Item(453, 4) }, new Item[] { new Item(2359) }, 30, 50),
	MITHRIL_5(7440, MITHRIL, 5), MITHRIL_10(6397, MITHRIL, 10), MITHRIL_X(4158, MITHRIL, -1),
	ADAMANT(7446, new Item[] { new Item(449), new Item(453, 6) }, new Item[] { new Item(2361) }, 37.5, 70),
	ADAMANT_5(7444, ADAMANT, 5), ADAMANT_10(7443, ADAMANT, 10), ADAMANT_X(7442, ADAMANT, -1),
	RUNITE(7450, new Item[] { new Item(451), new Item(453, 8) }, new Item[] { new Item(2363) }, 50, 85),
	RUNITE_5(7449, RUNITE, 5), RUNITE_10(7448, RUNITE, 10), RUNITE_X(7447, RUNITE, -1);
