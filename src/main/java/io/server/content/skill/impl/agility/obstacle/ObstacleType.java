...
import io.server.content.skill.impl.agility.obstacle.impl.ArdougneJumpGapInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.ArdougneRoofJumpInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.ArdougneRoofJumpInteraction2;
import io.server.content.skill.impl.agility.obstacle.impl.ArdougneWallClimbInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.ClimbInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.ClimbOverInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.RopeSwingInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.RunningStartInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.SeersClimbInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.SeersJumpGapInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.SeersJumpGapInteraction2;
import io.server.content.skill.impl.agility.obstacle.impl.SteppingStonesInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.SwingAcrossCableInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.WalkInteraction;
import io.server.content.skill.impl.agility.obstacle.impl.WildernessDoorInteraction;
...
public enum ObstacleType {
	...
	public void execute(Player player, Obstacle next, Position start, Position end, int level, float experience,
			int ordinal) {
