...
public enum FishingSpot {
	SMALL_NET_OR_BAIT(1518, new Fishable[] { Fishable.SHRIMP, Fishable.ANCHOVIES },
			new Fishable[] { Fishable.SARDINE, Fishable.HERRING, Fishable.PIKE }),
	LURE_OR_BAIT(1526, new Fishable[] { Fishable.TROUT, Fishable.SALMON },
			new Fishable[] { Fishable.SARDINE, Fishable.HERRING, Fishable.PIKE }),
	CAGE_OR_HARPOON(1519, new Fishable[] { Fishable.LOBSTER }, new Fishable[] { Fishable.TUNA, Fishable.SWORD_FISH }),
	LARGE_NET_OR_HARPOON(1520, new Fishable[] { Fishable.MACKEREL, Fishable.COD, Fishable.BASS },
			new Fishable[] { Fishable.SHARK }),
	HARPOON_OR_SMALL_NET(1534, new Fishable[] { Fishable.MONK_FISH },
			new Fishable[] { Fishable.TUNA, Fishable.SWORD_FISH }),
