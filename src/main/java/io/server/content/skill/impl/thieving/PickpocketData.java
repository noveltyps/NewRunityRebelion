...
public enum PickpocketData {
	...
	MASTER_FARMER(new int[] { 3257 }, 38, 43, 5, 3, new Item(Config.CURRENCY, 1150), new Item(5291, 1),
			...
			new Item(5302, 1), new Item(5303, 1), new Item(5304, 1)),
	VARROCK_GUARD(new int[] { 3010 }, 40, 46.8, 5, 2, new Item(Config.CURRENCY, 1250)),
	BEARDED_POLLNIVNIAN_BANDIT(new int[] { 736 }, 45, 65, 5, 5, new Item(Config.CURRENCY, 1450), new Item(1523, 1),
			new Item(179, 1)),
	DESERT_BANDIT(new int[] { 693 }, 53, 79.5, 5, 3, new Item(Config.CURRENCY, 1450), new Item(1523, 1),
			new Item(179, 1)),
	...
	GNOME(new int[] { 6094 }, 75, 198.5, 5, 1, new Item(Config.CURRENCY, 6000), new Item(557, 5), new Item(445, 2),
			new Item(570, 2)),
	HERO(new int[] { 3106 }, 80, 275, 6, 4, new Item(Config.CURRENCY, 6000), new Item(Config.CURRENCY, 4500),
			new Item(565, 3), new Item(1602, 2), new Item(1994, 2)),
	ELF(new int[] { 5298 }, 85, 353, 6, 5, new Item(Config.CURRENCY, 6000), new Item(Config.CURRENCY, 5500),
			new Item(565, 3), new Item(1602, 2), new Item(1994, 2));
