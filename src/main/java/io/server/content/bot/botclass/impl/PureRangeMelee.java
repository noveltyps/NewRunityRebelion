...
public class PureRangeMelee extends SimplifiedListener<Player> implements BotClass {
	...
	public Item[] inventory() {
		return new Item[] { new Item(2444), new Item(12695), new Item(3144), new Item(3144), new Item(3024),
				new Item(3024), new Item(3144), new Item(3144), new Item(3024), new Item(3024), new Item(391),
				new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391),
				new Item(391), new Item(391), new Item(391), new Item(11802), new Item(391), new Item(391),
				new Item(391), new Item(391), new Item(391), new Item(391) };
	}

	@Override
	public Item[] equipment() {
		return new Item[] { new Item(2900), new Item(10498), new Item(1129), new Item(11978), new Item(892, 125),
				new Item(3105), new Item(2497), new Item(861), new Item(2491) };
	}
	...
	public void endFight(PlayerBot bot) {
		bot.prayer.deactivate(Prayer.PROTECT_ITEM, Prayer.SMITE, Prayer.EAGLE_EYE, Prayer.ULTIMATE_STRENGTH,
				Prayer.STEEL_SKIN, Prayer.INCREDIBLE_REFLEXES);
	}
	...
	public void hit(Player attacker, Mob defender, Hit hit) {
		...
		boolean lowHp = defender.getCurrentHealth() <= defender.getMaximumHealth() * RandomUtils.inclusive(0.50, 0.60);
	...
	public void pot(Player target, PlayerBot bot) {
		...
		if (target.getCurrentHealth() <= Math.floor(target.getMaximumHealth() * 0.15) && max < bot.getCurrentHealth())
			return;
		...
		if (checkSkill(bot, Skill.PRAYER, 25)) {
			...
			if (checkSkill(bot, Skill.ATTACK, 71) || checkSkill(bot, Skill.STRENGTH, 115)
	...
	public void eat(Player target, PlayerBot bot) {
		...
		if (bot.getCurrentHealth() >= bot.getMaximumHealth() * 0.15)
			return;
