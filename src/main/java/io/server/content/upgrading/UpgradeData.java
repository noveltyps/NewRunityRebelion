...
public enum UpgradeData {
	...
	REBELIONX_PLATEBODY(new Item(17164, 1), new Item(17167, 1), new Item(21820, 250), 0.20),
	REBELIONX_HELM(new Item(17163, 1), new Item(17166, 1), new Item(21820, 250), 0.20),
	REBELIONX_PLATELEGS(new Item(17165, 1), new Item(17168, 1), new Item(21820, 250), 0.20),
	...
	public static Item[] ITEMS = new Item[] {
			...
			REBELIONX_PLATEBODY.getItemReward(),
			REBELIONX_HELM.getItemReward(),
			REBELIONX_PLATELEGS.getItemReward(),
