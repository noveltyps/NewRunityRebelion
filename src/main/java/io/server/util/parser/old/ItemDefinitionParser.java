...
import io.server.util.parser.old.defs.ItemDefinition;
...
public class ItemDefinitionParser extends GsonParser {
	...
	protected void parse(JsonObject data) {
		...
		ItemDefinition.DEFINITIONS[id] = new ItemDefinition(id, name, members, tradeable, stackable, droppable,
				noteable, noted, notedId, street_value, base_value, high_alch, low_alch, examine, destroyMessage,
				weight);
	}
}
