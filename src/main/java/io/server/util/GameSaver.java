...
import io.server.content.WellOfGoodwill.Contributor;
	...
	public static void load() {
		new GsonParser("content/game/world") {
			...
			protected void parse(JsonObject object) {
				...
				BotUtility.BOOT_LOOT = GsonUtils.JSON_PRETTY_ALLOW_NULL.fromJson(object.get("pk-bot-loot"),
						new TypeToken<HashMap<Integer, MutableNumber>>() {
						}.getType());
			}
		}.run();
	}
