 ...
 */
public final class SecretsChestAction2 extends Action<Player> {

	//private final GameObject object;

	public SecretsChestAction2(Player player/*, GameObject object*/) {
		super(player, 1);
		//this.object = object;
	}
	...
	protected void onSchedule() {
		getMob().locking.lock();
		getMob().inventory.remove(3462, 1);
	...
	protected void onCancel(boolean logout) {
		...
		AchievementHandler.activate(getMob(), AchievementKey.SECRETS_CHEST_2, 1);
		getMob().send(new SendMessage("...you find a few items inside of the chest."));
		getMob().activityLogger.add(ActivityLog.SECRETS_CHEST_2);
	}

	@Override
	public String getName() {
		return "Secrets chest 2";
	}
