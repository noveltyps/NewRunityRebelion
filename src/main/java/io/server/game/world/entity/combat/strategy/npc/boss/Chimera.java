...
/**
 * The combat definition for Chimera.
 *
 * @author Adam_#6723
 */
public class Chimera extends MultiStrategy {
	...
	private static class VenomSpecial extends NpcMagicStrategy {
		...
		public void start(Npc attacker, Mob defender, Hit[] hits) {
			World.schedule(2, () -> {
				attacker.animate(new Animation(7036, UpdatePriority.HIGH));
	...
	private static class RangedAttack extends NpcRangedStrategy {
		...
		RangedAttack() {
			super(CombatProjectile.getDefinition("Chimera Ranged"));
		}

		@Override
		public Animation getAttackAnimation(Npc attacker, Mob defender) {
			return new Animation(7036, UpdatePriority.HIGH);
		}
	...
	private static class MagicAttack extends NpcMagicStrategy {
		...
		MagicAttack() {
			super(CombatProjectile.getDefinition("Chimera Magic"));
		}
	...
	private static class FrozenSpecial extends NpcMagicStrategy {
		...
		FrozenSpecial() {
			super(CombatProjectile.getDefinition("Chimera Frozen Special"));
		}
	...
	private static class DragonfireAttack extends DragonfireStrategy {
		DragonfireAttack() {
			super(CombatProjectile.getDefinition("Metalic Chimera dragonfire"));
		}
	...
	private static class VenomDragonfireAttack extends DragonfireStrategy {
		VenomDragonfireAttack() {
			super(CombatProjectile.getDefinition("Chimera Venom Dragonfire"));
		}
	...
	private static class PinkDragonfireAttack extends DragonfireStrategy {
		PinkDragonfireAttack() {
			super(CombatProjectile.getDefinition("Chimera Pink Dragonfire"));
		}
