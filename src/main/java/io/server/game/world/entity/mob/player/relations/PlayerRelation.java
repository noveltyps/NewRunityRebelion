package io.server.game.world.entity.mob.player.relations;

import java.util.ArrayList;
import java.util.List;
import java.util.Optional;

import io.server.game.event.impl.log.PrivateMessageChatLogEvent;
import io.server.game.world.World;
import io.server.game.world.entity.mob.player.Player;
import io.server.game.world.entity.mob.player.punishments.PunishmentExecuter;
import io.server.net.packet.out.SendAddFriend;
import io.server.net.packet.out.SendAddIgnore;
import io.server.net.packet.out.SendChatOption;
import io.server.net.packet.out.SendMessage;
import io.server.net.packet.out.SendPrivateMessage;
import io.server.net.packet.out.SendPrivateMessageListStatus;
		...
		for (Player players : World.getPlayers()) {
			...
			if (player.relations.friendList.contains(players.usernameLong)) {
				if (players.relations.privateChatMode.equals(PrivacyChatMode.FRIENDS_ONLY)
						&& !players.relations.getFriendList().contains(player.usernameLong)
						|| players.relations.privateChatMode.equals(PrivacyChatMode.OFF)
						|| players.relations.getIgnoreList().contains(player.usernameLong)) {
					tempOn = false;
				}
