...
public class ReferralSystem {
	...
	public static void handleReferral(Player player) {
		...
		player.send(new SendInputMessage("Who refered/Invited you to RebelionX? Mention them for free Silver Box!", 20, input -> {
			try {
...
//			}
		...
		refer.sendMessage("You have recieved a Referral Mystery Box by Joining via an existing member on RebelionX!");
