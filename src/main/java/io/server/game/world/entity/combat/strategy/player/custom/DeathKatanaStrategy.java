...
public class DeathKatanaStrategy extends PlayerMeleeStrategy {

	private static final DeathKatanaStrategy INSTANCE = new DeathKatanaStrategy();
	...
	public static DeathKatanaStrategy get() {
		return INSTANCE;
	}
