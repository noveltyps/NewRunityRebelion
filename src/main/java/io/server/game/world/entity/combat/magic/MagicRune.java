...
public enum MagicRune {
	...
	AIR_RUNE(556, new int[] { 4695, 4696, 4697 },
			new int[] { 1381, 1397, 1405, 11998, 12000, 20730, 20733, 20736, 20739 }),
	FIRE_RUNE(554, new int[] { 4694, 4697, 4699 },
			new int[] { 1387, 1393, 1401, 11998, 12000, 11787, 3053, 3054, 12795 }),
	WATER_RUNE(555, new int[] { 4694, 4695, 4698 },
			new int[] { 1383, 1395, 1403, 20730, 20733, 6562, 6563, 11787, 11789, 12795 }),
	EARTH_RUNE(557, new int[] { 4698, 4696, 4699 },
			new int[] { 3053, 3054, 1385, 1399, 1407, 6562, 6563, 20736, 20739 }),
	MIND_RUNE(558, null, null), BODY_RUNE(559, null, null), DEATH_RUNE(560, null, null), NATURE_RUNE(561, null, null),
	CHAOS_RUNE(562, null, null), LAW_RUNE(563, null, null), COSMIC_RUNE(564, null, null), BLOOD_RUNE(565, null, null),
	SOUL_RUNE(566, null, null), ASTRAL_RUNE(9075, null, null), SARADOMIN_STAFF(-1, null, new int[2415]),
	GUTHIX_STAFF(-1, null, new int[2416]), ZAMORAK_STAFF(-1, null, new int[2417])
