...
public enum Direction {
	...
	public static final ImmutableList<Direction> DIRECTIONS = ImmutableList.of(NORTH_WEST, NORTH, NORTH_EAST, WEST,
			EAST, SOUTH_WEST, SOUTH, SOUTH_EAST);
	private static final Direction[] VALID = new Direction[] { NORTH, NORTH_EAST, EAST, SOUTH_EAST, SOUTH, SOUTH_WEST,
			WEST, NORTH_WEST };
