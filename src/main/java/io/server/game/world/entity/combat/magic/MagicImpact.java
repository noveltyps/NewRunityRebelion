...
public enum MagicImpact {
	...
	SMOKE_BURST((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> smokeBurst(attacker, defender, other, hit, extra))),
	SMOKE_BLITZ((attacker, defender, hit, extra) -> poison(attacker, defender, hit, PoisonType.SUPER_MAGIC)),
	SMOKE_BARRAGE((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> smokeBarrage(attacker, defender, other, hit, extra))),

	SHADOW_RUSH((attacker, defender, hit, extra) -> lowerSkill(defender, Skill.ATTACK, 10)),
	SHADOW_BURST((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> shadowBurst(attacker, defender, other, extra))),
	SHADOW_BLITZ((attacker, defender, hit, extra) -> lowerSkill(defender, Skill.ATTACK, 15)),
	SHADOW_BARRAGE((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> shadowBarrage(attacker, defender, other, extra))),

	BLOOD_RUSH((attacker, defender, hit, extra) -> heal(attacker, hit)),
	BLOOD_BURST((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> bloodBurst(attacker, defender, other, hit, extra))),
	BLOOD_BLITZ((attacker, defender, hit, extra) -> heal(attacker, hit)),
	BLOOD_BARRAGE((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> bloodBarrage(attacker, defender, other, hit, extra))),

	ICE_RUSH((attacker, defender, hit, extra) -> freeze(defender, 5)),
	ICE_BURST((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> iceBurst(attacker, defender, other, extra))),
	ICE_BLITZ((attacker, defender, hit, extra) -> freeze(defender, 15)),
	ICE_BARRAGE((attacker, defender, hit, extra) -> CombatUtil.areaAction(defender,
			other -> iceBarrage(attacker, defender, other, extra))),
...
//        }
	...
	private static void smokeBurst(Mob attacker, Mob defender, Mob other, Hit hit, List<Hit> extra) {
		...
		CombatHit next = hitEvent(attacker, defender, other, 24, extra);
	...
	private static void smokeBarrage(Mob attacker, Mob defender, Mob other, Hit hit, List<Hit> extra) {
		...
		CombatHit next = hitEvent(attacker, defender, other, 33, extra);
		if (next != null && (attacker.isNpc() || (next.isAccurate() && next.getDamage() > 0))) {
	...
	private static void shadowBurst(Mob attacker, Mob defender, Mob other, List<Hit> extra) {
		...
		CombatHit next = hitEvent(attacker, defender, other, 25, extra);
	...
	private static void shadowBarrage(Mob attacker, Mob defender, Mob other, List<Hit> extra) {
		...
		CombatHit next = hitEvent(attacker, defender, other, 34, extra);
		if (next != null && next.isAccurate()) {
