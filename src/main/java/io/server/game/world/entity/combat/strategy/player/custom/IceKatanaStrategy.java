...
public class IceKatanaStrategy extends PlayerMeleeStrategy {

	private static final IceKatanaStrategy INSTANCE = new IceKatanaStrategy();
	...
	public static IceKatanaStrategy get() {
		return INSTANCE;
	}
