...
public class Skill implements InteractionEventListener {
	...
	public static final int[][] INTERFACE_DATA = { { 4004, 4005 }, { 4008, 4009 }, { 4006, 4007 }, { 4016, 4017 },
	...
	public int boostedSkill;
	
	public int getBoostedSkill() {
		return boostedSkill;
	}
	 ...
	 *                 the new level as an output. kk imma look at console real quick
	 *                 
	 */
	public void modifyLevel(Function<Integer, Integer> function, boolean levelUp) {
		modifyLevel(function, 0, maxLevel, levelUp);
	}
	public void modifyLevel(Function<Integer, Integer> function) {
		modifyLevel(function, 0, maxLevel, false);
	}
	 ...
	 * @param lowerBounds The lowest value the level can be modified to. nvm..
	 * @param upperBounds The highest value the level can be modified to.
	 */
	public void modifyLevel(Function<Integer, Integer> function, int lowerBounds, int upperBounds, boolean levelUp) {
	...
	public String toString() {
		return String.format("Skill[name=%s, id=%s, level=%s, max=%s, experience=%s]", getName(skill), skill, level,
				maxLevel, experience);
	}
	...
	public boolean onEvent(Player player, InteractionEvent interactionEvent) {
		...
		dispatcher.dispatch(InteractionType.FIRST_ITEM_CLICK,
				e -> clickItem(player, (FirstItemClickInteractionEvent) e));
		dispatcher.dispatch(InteractionType.SECOND_ITEM_CLICK,
				e -> clickItem(player, (SecondItemClickInteractionEvent) e));
		dispatcher.dispatch(InteractionType.THIRD_ITEM_CLICK,
		...
		dispatcher.dispatch(InteractionType.ITEM_CONTAINER_INTERACTION_EVENT,
