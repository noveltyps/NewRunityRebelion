...
import io.server.content.activity.impl.raids.Raids;
...
public class Raids14Session extends DynamicRegionHandler {
	...
	public void onStart(Player player) {
		...
		for (Player p : partners)
			p.locking.lock();
		player.send(new SendFadeScreen("Welcome to the Raids 1!", 1, 3));
		World.sendMessage(player.getName() + " Was Litty enough to take on Raids 1!");
		World.schedule(5, () -> {
			Raids.create(player, partners);
