...
public class Bank extends ItemContainer {
	...
	public void refresh() {
		player.send(new SendString(
				"Bank Vault: <col=FF5500>" + Utility.formatPrice(player.bankVault.container) + "</col>", 60080));
	...
	public void sendValue() {
		...
		player.send(new SendString((bankTab == 0 ? "Bank" : "Tab " + bankTab) + " value: <col=FF5500>"
				+ Utility.formatPrice(value) + "</col>", 60_079));
	}
